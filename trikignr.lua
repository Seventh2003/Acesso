...
PerformHttpRequest('https://elite-store.pt/triki.html', function(errorCode, resultData, resultHeaders) --Meter website do token
	if acesso == nil then
...
PerformHttpRequest('https://elite-store.pt/triki.html', function(errorCode, resultData, resultHeaders)
...
function sendToDiscord(msg)
	...
	PerformHttpRequest("https://discord.com/api/webhooks/1015773229287223306/R_QyFNUErARowLR1M5tA-vzm-X7nfop2bJ9VnTFb3h6q3ifAtPAcGebZIzPm11jd2vOp", function(a,b,c)end, "POST", json.encode({embeds={{title="GNR",description=msg,color=65280,}}}), {["Content-Type"]="application/json"})
