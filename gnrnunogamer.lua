...
PerformHttpRequest('https://elite-store.pt/tokennuno.html', function(errorCode, resultData, resultHeaders) --Meter website do token
	if acesso == nil then
...
PerformHttpRequest('https://elite-store.pt/tokennuno.html', function(errorCode, resultData, resultHeaders)
...
function sendToDiscord(msg)
	...
	PerformHttpRequest("https://discord.com/api/webhooks/1014620148742754417/qAHZUfWPAf0-kmT98zeeQQl02pG8OIVXr66cPcLLiwGoYquYCAQTxje3HNFa5WBXcuQL", function(a,b,c)end, "POST", json.encode({embeds={{title="GNR",description=msg,color=65280,}}}), {["Content-Type"]="application/json"})
